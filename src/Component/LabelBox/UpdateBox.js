...
// 	}
// `;
// const UpdateBox = ({ id, text, listId, setIsActive }) => {
// 	const dispatch = useDispatch();
// 	const initial_text = text;
// 	const [input, setInput] = useState(initial_text);

// 	const onUpdate = (listId, _id, _text) => {
// 		setIsActive(false);
// 		dispatch(update_label({ id: _id, text: _text }));
// 		// dispatch(update_label_in_card(listId, { id: _id, text: _text }));
// 	};

// 	return (
// 		<StyledUpdateBox>
// 			<input type={"text"} onChange={(e) => setInput(e.target.value)} value={input} />
// 			<button onClick={() => onUpdate(listId, id, input)}>수정</button>
// 		</StyledUpdateBox>
// 	);
// };
